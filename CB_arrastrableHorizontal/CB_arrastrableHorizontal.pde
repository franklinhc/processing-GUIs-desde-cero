/*
sktech para mostrar cómo se arrastra un objeto en sentido horizontal
 
 ph.d. franklin hernández-castro | tec costa rica | HfG gmuend | junio 2022
 www.skizata.com
 */

int cantidadDeObjetos = 3;
...
void setup() {
  ...
  for (int i = 0; i < cantidadDeObjetos; i++) {
    misObjetos[i] = new ObjetoArrastrable ( random (width), random(height*0.25,height*0.75) );
  }
} // end setup()
